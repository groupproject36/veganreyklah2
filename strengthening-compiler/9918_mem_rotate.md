...
| File | Audit | Status |
|------|-------|--------|
| `rye/lib/std/mem.zig` | `rotate` — max_rotate_check, max_replace_input, max_replace_check `u32`; public `usize` unchanged | done |
...
- [x] `std.mem.rotate` — [`rye/lib/std/mem.zig`](../rye/lib/std/mem.zig)
