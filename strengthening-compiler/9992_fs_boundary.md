...
| File | Audit | Status |
|------|-------|--------|
| `rye/lib/std/fs.zig` | `fs` — Phase 4 `usize` seam policy applied | done |
| `rye/lib/std/Io/Dir.zig` | `Dir` — Phase 4 `usize` seam policy applied | done |
| `rye/tests/fs_boundary_test.rye` | witness program | done |
| `tools/parity.rish` | witness registered | done |
| `strengthening-compiler/9992_fs_boundary.md` | pass record + audited surfaces | done |
| `992_strengthening_width_crosswalk.md` | lexicon row 9992 | done |

## Audited surfaces

Width audit at strengthen touch ([`992` Phase 4](../work-in-progress/992_usize_width_baseline.md)). Each surface this pass strengthens:

- [x] `std.fs` — [`rye/lib/std/fs.zig`](../rye/lib/std/fs.zig)
- [x] `std.Io.Dir` — [`rye/lib/std/Io/Dir.zig`](../rye/lib/std/Io/Dir.zig)
