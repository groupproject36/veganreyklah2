...
| File | Audit | Status |
|------|-------|--------|
| `rye/lib/std/SemanticVersion.zig` | `format` — Phase 4 `usize` seam policy applied | done |
...
- [x] `std.SemanticVersion.format` — [`rye/lib/std/SemanticVersion.zig`](../rye/lib/std/SemanticVersion.zig)
