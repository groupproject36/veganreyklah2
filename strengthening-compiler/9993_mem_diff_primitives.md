...
| File | Audit | Status |
|------|-------|--------|
| `rye/lib/std/mem.zig` | `diff_primitives` — Phase 4 `usize` seam policy applied | done |
| `rye/tests/mem_diff_test.rye` | witness program | done |
| `tools/parity.rish` | witness registered | done |
| `strengthening-compiler/9993_mem_diff_primitives.md` | pass record + audited surfaces | done |
| `992_strengthening_width_crosswalk.md` | lexicon row 9993 | done |

## Audited surfaces

Width audit at strengthen touch ([`992` Phase 4](../work-in-progress/992_usize_width_baseline.md)). Each surface this pass strengthens:

- [x] `std.mem.diff_primitives` — [`rye/lib/std/mem.zig`](../rye/lib/std/mem.zig)
