...
Like the other stacks, this folder counts **down**. This foundation claims `999`. The first reference takes `998`, the next `997`, and so the sequence descends, newest on top under plain alphabetical sorting.
