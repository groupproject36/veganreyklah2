...
- **`993_aurora_boot_riscv.md`** — Aurora, the boot in cohesion with RISC-V; the flow of named values; content-addressed stages; the owner's key.
- **`998_MANTRA.md`** — Mantra, version control as a weave; always-succeeding merges; SHA3-512 naming; conflicts that inform.
