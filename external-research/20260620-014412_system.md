...
Jason Cohen's **Simple, Lovable, Complete** names how we ship: a small product a person genuinely wants to use *as-is*, not an embarrassing minimum. Our first SLC is the Rishi + Mantra shell; Pond GUI grows as the next ring (`../work-in-progress/ROADMAP.md`).
...
We honor DVUI as a source we study, kept whole in `../gratitude/dvui`, and we do not absorb it: Brushstroke is written fresh in Rye, on our own ground, carrying the essence and leaving the code where its author put it. Its design is applied and weighed in `980`, the documentation-surface study, and distilled onto its own roots in `../active-designing/20260619-072600_brushstroke.md`.
...
- **`../gratitude/dvui/`** — David Vanderson's DVUI, the immediate-mode interface toolkit whose redraw-from-values and backend abstraction seed our own surface, **Brushstroke**. Applied in `980`, and distilled onto its own roots in `../active-designing/20260619-072600_brushstroke.md`. MIT, cloned shallow.
