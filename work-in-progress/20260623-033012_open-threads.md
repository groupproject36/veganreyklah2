...
> **Historical snapshot.** The living plan is [`ROADMAP.md`](ROADMAP.md) and [`TASKS.md`](TASKS.md). TAME hardening closed `2026-06-29` (TH-7); parity **132** with blocking hosted `width-check`. This file keeps the accreted "What Just Landed" stack until archived per TASKS open-threads hygiene.
