...
- **Strengthening passes 9979–9919** — `trimStart` … mem.swap. Each through the gate; witness count 17 → 84.
...
- [x] **Strengthening 9979–9919** — everyday `std` surfaces through the gate (`trimStart` … mem.swap; see `strengthening-compiler/9919`–`9987`).
...
1. **Strengthening series** — next `std` surface (`9918` and below; `998`) — invoke with **`k <stamp>`**
