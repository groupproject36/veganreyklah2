...
- [x] **Strengthening 9979–9918** — everyday `std` surfaces through the gate (`trimStart` … mem.rotate; see `strengthening-compiler/9918`–`9987`).
...
1. **Strengthening series** — next `std` surface (`9917` and below; `998`) — invoke with **`k <stamp>`**
