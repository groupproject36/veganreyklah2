...
1. **Strengthening series** — next `std` surface (`9912` and below; `998`) — invoke with **`k <stamp>`**; each pass includes width audit on affected files
