...
- **Strengthening passes 9979–9917** — `trimStart` … mem.replace. Each through the gate; witness count 17 → 86.
...
- [x] **Strengthening 9979–9917** — everyday `std` surfaces through the gate (`trimStart` … mem.replace; see `strengthening-compiler/9917`–`9987`).
...
1. **Strengthening series** — paused at **9916**; `strengthening-compiler/` is now our stdlib doc folder (`10025`, `992` crosswalk) — resume with **`k <stamp>`**
