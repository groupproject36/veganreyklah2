...
- **Strengthening 9994–9928** — through mem.span. 75 witnesses.
...
|----------|--------|--------|
| 1 | **Strengthening series** — next `std` surface through gate trio (9927 and below) | `10023` Track B, `998` |
...
- **Witnesses:** 75 programs, all GREEN (9928 mem.span latest).
