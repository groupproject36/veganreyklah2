...
*A living snapshot of what has landed, what is closed, and what remains open. Updated at `165512`: pass 9968 `SplitIterator.rest`; corpus 35.*
...
- **Strengthening pass 9968 (`165512`).** `SplitIterator.rest` postcondition; corpus 35/35 GREEN. Mantra tab/line tails.
...
- **Strengthening 9994–9968** — through `SplitIterator.rest`. Corpus 35.
...
|----------|--------|--------|
| 1 | **Strengthening series** — next `std` surface through gate trio (9967 and below) | `10023` Track B, `998` |
...
- **Corpus:** 35 programs, all GREEN (9968 `SplitIterator.rest` latest).
