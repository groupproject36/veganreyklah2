...
1. **TAME hardening** — **TH-0–TH-5 done**; **RS-1** Rishi script args (**Claude strategy pause**); RS-2–RS-3 beside it. Flip `width-check` into parity when global authored-`usize` count hits zero (Comlink + Aurora remain).
