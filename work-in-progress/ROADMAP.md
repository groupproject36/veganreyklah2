...
1. **TAME hardening** — **TH-0 done** (TAME Guidance rename); **TH-1 done** (width-check seam-aware); **TH-2** first `tame-check` lints keystone, then TH-2b–TH-5; RS-1–RS-3 beside it in Rishi.
