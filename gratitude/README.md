...
- **`sixos/`** — Adam Joseph's nixpkgs-based operating system that runs s6 in place of systemd. Its services-as-packages design and careful layering shape our thinking on the Caravan kernel, explored in `../external-research/20260617-195712_caravan-tally-networking.md` and `../external-research/yonder/20260617-195612_ownerboot-riscv-caravan.md`. Cloned whole and unmodified (rev `a984ac7`).
